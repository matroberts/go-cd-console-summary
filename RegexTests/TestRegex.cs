...
namespace RegexTests
{
    ...
    */
    ...
    public class TestRegex
    {
        ...
        [TestCase("BuildServer4", @"21:19:03.383   C:\GoAgent\pipelines\Deploy-DevNetBackup\DirectaArtifacts\Deployment\Deploy.proj(407,5): warning : Access to the path 'AntiXssLibrary.dll' is denied.")]
        [TestCase("BuildServer5", @"21:19:03.383   C:\GoAgent\pipelines\Deploy-DevNetBackup\DirectaArtifacts\Deployment\Deploy.proj(407,5): error : UnauthorizedAccessException: Access to the path 'AntiXssLibrary.dll' is denied.")]
